$(document).ready(function(){
  ...
  var genSource = function(){
    ...
    var temp = $temptxt.html().replace(/\n\ \ \ \ \ \ \ \ \ \ \ \ /g,"\n");
    $($temptxt).find('.control-group').each(function(i, item){
      var temp = {};
      var label = $(item).find('label');
      var input = $(item).find('.controls > input');
      temp['label'] = label.text();
      temp['placeholder'] = input.attr('placeholder');
      temp['name'] = input.attr('name');
      temp['type'] = input.attr('data-type');
      obj.push(temp);
    })
    // val(temp)
    $("#source").val(JSON.stringify(obj));
  }
  ...
  $("#target").delegate(".component", "click", function(e){
    ...
    $(".popover").delegate(".btn-info", "click", function(e){
      ...
      var valuename = $active_component.find('[data-name="'+vartype+'"]')
      var valuetype = $active_component.find('[data-type="'+vartype+'"]')
      if(vartype==="placeholder"){
        $(value).attr("placeholder", $(e).val());
      }else if (vartype==="columnName"){
        $(valuename).attr("name", $(e).val());
      } else if (vartype==="columnType"){
        $(valuetype).attr("data-type", $(e).val());
